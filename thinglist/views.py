...
def item(request, category_name, item_name):
  ...
  context = {'name':item.category, 'item': item, 'note_list': note_list}
...
def note(request, category_name, item_name, note_id):
  note = Note.objects.get(id=note_id)
  context = {'name': category_name, 'item': item_name, 'note': note}
